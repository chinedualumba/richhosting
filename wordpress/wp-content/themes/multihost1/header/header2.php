        ...
        <div id="header-top">
            <div class="container">
                <div class="column dt-sc-one-half first">
                    <p class="contact">
                        <?php echo dttheme_option('general','topbar-emailid-text');?>
                        <span><a href="mailto:<?php echo dttheme_option('general','topbar-emailid');?>"><?php echo esc_html( dttheme_option('general','topbar-emailid') );?></a>
                        </span>
                    </p>
                </div>
