        ...
        <div id="header-top">
            <div class="container">
                ...
                <div class="column dt-sc-one-half alignright">
                    <p class="contact">
                        <?php echo dttheme_option('general','topbar-phoneno-text');?>
                        <span><?php echo esc_html( dttheme_option('general','topbar-phoneno') );?></span>
                    </p>
                </div>
            </div>
					...
					if ( function_exists('wp_nav_menu') ):
						$primaryMenu = wp_nav_menu(
							array(
								...
								'echo'=>false,
								'container'=>false,
								'items_wrap'=>'<ul id="%1$s" class="group nav-line %2$s"><li class="menu-item current_page_item"><a href="#'.$lp_name.'">'.$lp_title.'</a></li>%3$s</ul>',
