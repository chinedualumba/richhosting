...
function plugin_head_styles_scripts() {
	...
	wp_enqueue_script('pace-script', IAMD_FW_URL.'js/public/pace.min.js',array(),false,true);
	...
	wp_enqueue_script('uitop-script', IAMD_FW_URL.'js/public/jquery.ui.totop.min.js',array(),false,true);
	...
	if( is_page_template('tpl-onepage.php') ) {
		wp_enqueue_script('onepage-script', IAMD_FW_URL.'js/public/jquery.nav.min.js',array(),false,true);
	}
	...
	wp_enqueue_script('carouFredSel-script', IAMD_FW_URL.'js/public/jquery.carouFredSel-6.2.1-packed.js',array(),false,true);
...
function dttheme_seo_meta() {
	...
	if (!$status) :
		...
		if (dttheme_option('seo', 'use_canonical_urls')) :
			...
			if ($url) {
				$output .= "<link rel='canonical' href='".esc_url( $url )."'/>\r";
			}
		endif;
...
function dttheme_appearance_css() {
	...
	if (dttheme_option('integration', 'enable-custom-css')) :
		...
		$output .= htmlspecialchars_decode(stripcslashes($css));
...
function dttheme_color_picker(){
	...
	echo '	<a href="" title="" class="style-picker-ico"> <img class="rotating" src="'.IAMD_BASE_URL.'images/style-picker/picker-icon.png" alt="" title="" /> </a>';
	echo '	<div id="dt-style-picker">';
	echo '   	<h2>'.__('Select Your Style','dt_themes').'</h2>';
	
	echo '       <h3>'.__('Choose your layout','dt_themes').'</h3>';
	echo '		<ul class="layout-picker">';
	echo '       	<li> <a id="fullwidth" href="" title="" class="selected"> <img src="'.IAMD_BASE_URL.'images/style-picker/fullwidth.jpg" alt="" title="" /> </a> </li>';
	echo '       	<li> <a id="boxed" href="" title=""> <img src="'.IAMD_BASE_URL.'images/style-picker/boxed.jpg" alt="" title="" /> </a> </li>';
	echo '		</ul>';
	echo '		<div class="dt-hr"> </div>';
	echo '		<div id="pattern-holder" style="display:none;">';
	echo'			<h3>'.__('Patterns for Boxed Layout','dt_themes').'</h3>';
	echo '			<ul class="pattern-picker">';
	echo 				$patterns;
	echo '			</ul>';
	echo '			<div class="dt-hr"> </div>';
	echo '		</div>';
	
	echo '		<h3>'.__('Color scheme','dt_themes').'</h3>';
	echo '		<ul class="color-picker">';
	echo 		$colors;
	echo '		</ul>';
