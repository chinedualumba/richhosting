...
function dttheme_image_attachment_option($form_fields, $post){
	...
	$send = "<input type='submit' class='button' name='send[".esc_attr($attachment_id)."]' value='" . esc_attr__( 'Insert this Image' , 'dt_themes' ) . "' />";
	$send .= "<input type='radio' checked='checked' value='full' id='image-size-full-".esc_attr($attachment_id)."' name='attachments[".esc_attr($attachment_id)."][image-size]' style='display:none;' />";
	$send .= "<input type='hidden' value='' name='attachments[".esc_attr($attachment_id)."][post_title]' id='attachments[".esc_attr($attachment_id)."][post_title]' />";
	$send .= "<input type='hidden' value='' name='attachments[".esc_attr($attachment_id)."][url]' id='attachments[".esc_attr($attachment_id)."][url]' />";
	$send .= "<input type='hidden' value='' name='attachments[".esc_attr($attachment_id)."][post_excerpt]' id='attachments[".esc_attr($attachment_id)."][post_excerpt]' />";
