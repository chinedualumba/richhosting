    ...
    <div class="bpanel-main-content">
        ...
        <div id="integration-general">
        	<?php $integration_general = array( 
					array(
						"title"=>		__('Add Code Inside the head tag','dt_themes'),
						"tooltip"=>		__('Any code you place here will appear in the head section of every page of your site. This code wrapped between scripts tags.','dt_themes'),
						"textarea"=>	"header-code",
						"checkbox"=>	"enable-header-code",
						"label"=>		__('Enable Header Code','dt_themes')
					),
					array(
						"title"=>		__('Add Code above closing body tag;','dt_themes'),
						"tooltip"=>		__('You can paste your Google Analytics or other website tracking codes in this box. This code wrapped between scripts tags.','dt_themes'), 
						"textarea"=>	"body-code",
