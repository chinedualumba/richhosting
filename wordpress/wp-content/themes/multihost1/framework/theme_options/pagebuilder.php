            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">                
                    <div class="bpanel-option-set">
                        ...
                        <h6><?php _e('Choose any of these post types to activate page builder','dt_themes');?></h6><?php
                        ...
                        foreach ( $post_types as $key => $pname ) {
                            ...
                            <div class="column one-third">
                                <label><?php echo esc_attr($obj->labels->singular_name); ?></label>
                            </div>
                            <div class="column two-third last">
                                 <div data-for="mytheme-<?php echo esc_attr( $key );?>" class="checkbox-switch <?php echo esc_attr( $switchclass );?>"></div>
                                 <input class="hidden" id="mytheme-<?php echo esc_attr( $key );?>" type="checkbox" value="<?php echo esc_attr( $key );?>"
                                    name="mytheme[pagebuilder][post-types][<?php echo esc_attr( $key );?>]"                                    
                    ...
                    <div class="bpanel-option-set"><?php
                        ...
                        <input class="hidden" id="mytheme-enable-pagebuilder" <?php $checked; ?> name="mytheme[pagebuilder][enable-pagebuilder]" type="checkbox" value="true"/>
                        <div class="hr"></div>
                    </div><!-- .bpanel-option-set --> 
