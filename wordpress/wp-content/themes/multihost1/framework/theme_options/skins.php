        ...
        <ul class="sub-panel">
			<?php $sub_menus = array(
				  ...
				  foreach($sub_menus as $menu): ?>
                  	<li><a href="<?php echo esc_attr( $menu['link'] );?>"><?php echo esc_attr( $menu['title'] );?></a></li>
			<?php endforeach?>
        </ul>
	                ...
	                <?php $theme = dttheme_option('appearance','skin'); ?>
                	 <ul id="j-current-theme-container" class="skins-list" dummy-content="<?php echo esc_attr( $theme );?>-dummy">
                     	 <li data-attachment-theme="<?php echo esc_attr( $theme );?>">
                         	<?php $img = IAMD_BASE_URL.'skins/'.$theme.'/screenshot.png'; ?>
                            <img src="<?php echo esc_url( $img );?>" alt='' width='250' height='180' />
