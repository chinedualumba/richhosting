           	...
           	<div id="bpanel">
                	...
                	<div id="bpanel-left">
                    	...
                    	<div id="logo"><?php
							...
							<img src="<?php echo esc_url( $logo );?>" width="186" height="101" alt="" title="" />
						</div>
                    ...
                    <form id="mytheme_options_form" name="mytheme_options_form" method="post" action="options.php">
                        ...
                        <input type="hidden" name="mytheme_admin_wpnonce" value="<?php echo wp_create_nonce(IAMD_THEME_SETTINGS.'_wpnonce');?>" /><?php 
                            ...
                            require_once(get_template_directory().'/framework/theme_options/importer.php');
							
                        	require_once(get_template_directory().'/framework/theme_options/backup.php');?>

                        	<!-- #bpanel-bottom -->
                        	<div id="bpanel-bottom">
                        		<input type="submit" value="<?php esc_attr_e('Reset All','dt_themes');?>" class="save-reset mytheme-reset-button bpanel-button white-btn" name="mytheme[reset]" />
                        		<input type="submit" value="<?php esc_attr_e('Save All','dt_themes');?>" name="submit" class="save-reset mytheme-footer-submit bpanel-button white-btn" />
