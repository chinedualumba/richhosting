	...
	class DTPortfolioPostType {
		...
		function save_post_meta($post_id) {
			...
			if (isset($_POST['page-layout'])):
				...
				$settings = array ();
				$settings ['sub-title-bg'] = isset( $_POST['sub-title-bg'] )? dt_wp_kses($_POST['sub-title-bg']): "";
				...
				$settings ['author-name'] = isset ( $_POST ['author-name'] ) ? dt_wp_kses($_POST ['author-name']) : "";
				$settings ['website-link'] = isset ( $_POST ['website-link'] ) ? dt_wp_kses($_POST ['website-link']) : "";

				$settings ['items'] = isset ( $_POST ['items'] ) ? dt_wp_kses($_POST ['items']) : "";
				$settings ['items_thumbnail'] = isset ( $_POST ['items_thumbnail'] ) ? dt_wp_kses($_POST ['items_thumbnail']) : "";
				$settings ['items_name'] = isset ( $_POST ['items_name'] ) ? dt_wp_kses($_POST ['items_name']) : "";
