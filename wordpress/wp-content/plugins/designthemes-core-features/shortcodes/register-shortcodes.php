	...
	class DTCoreShortcodes {
		...
		function dt_init() {
			...
			if (! is_admin ()) {
				...
				wp_enqueue_script ( 'dt-sc-onepage-nav-script', plugin_dir_url ( __FILE__ ) . 'js/jquery.nav.min.js', array (), false, true );
		...
		function dt_the_content_filter($content) {
			$dt_shortcodes = array("dt_sc_accordion_group","dt_sc_button","dt_sc_blockquote","dt_sc_callout_box",
				...
				"dt_sc_five_sixth_inner","dt_sc_four_fifth_inner","dt_sc_doshortcode","dt_sc_address","dt_sc_phone","dt_sc_mobile",
				"dt_sc_fax","dt_sc_email","dt_sc_web","dt_sc_clients_carousel","dt_sc_donutchart","dt_sc_clear","dt_sc_hr_border","dt_sc_hr",
				...
				"dt_sc_title","dt_sc_title_with_icon",
				"dt_sc_toggle","dt_sc_toggle_framed","dt_sc_titled_box","dt_sc_tooltip","dt_sc_pullquote",
				"dt_sc_portfolio_item","dt_sc_portfolios","dt_sc_fullwidth_section",
				"dt_sc_fullwidth_video","dt_sc_animation","dt_sc_icon_title");
